                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="ml-auto">   
                        ...
                        <div class="social-wrap">
                            ...
                            <a href="#myModal" class="trigger-btn text-white" data-toggle="modal">Sign In</a>
                                ...
                                <div class="modal-content">
                                  <form action="login.php" method="post">
                                    ...
                                    <div class="modal-body">        
                                      ...
                                      <div class="form-group">
                                        <div class="clearfix">
                                          ...
                                          <a href="#" class="pull-right text-muted"><small>Forgot Password?</small></a>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <input type="submit" class="btn btn-danger pull-right" value="Login">
                                    </div>
                                  </form>
                                </div>
                              </div>
                            ...
                            <a href="#" class="d-inline-block d-lg-none site-menu-toggle js-menu-toggle text-black">
                                <span class="icon-menu h3 text-white" style="position: relative; top: 7px;"></span>
                            </a>

                            <!-- register button -->

                            <!-- Button HTML (to Trigger Modal) -->
                            <a href="#myModal1" class="trigger-btn text-white" data-toggle="modal">/ Register</a>
                                  ...
                                  <form action="signup.php" method="post">
                                    <div class="modal-header">        
                                      ...
                                      <div class="modal-body">        
                                          <div class="form-group">
                                            <label>Name</label>
                                            <input type="text" class="form-control" name="username" placeholder="Enter full name" required="required">
                                            ...
                                            <select class="custom-select" style="max-width: 120px;">
                                              ...
                                              <option value="1">+964</option>
                                              <option value="2">+37</option>
                                              <option value="3">+701</option>
                                            </select>
                                            <input type="phoneNumber" name="phonenum" required="required">
                                          </div>
                                          <div class="form-group">
                                            <div class="clearfix">
                                              <label>Password</label>
                                            </div>
                                            <input type="password" name="password" class="form-control input-sm" required="required" placeholder="Password">
                                          </div>
                                          <div class="form-group">
                                            <div class="clearfix">
                                              <label>Confirm Password</label>
                                            </div>
                                            <input type="password" class="form-control input-sm" required="required" placeholder="Confirm Password">
                                          </div>
                                          <div class="form-group">
                                            <label class="anim">
                                      ...
                                      <div class="modal-footer">
                                          <label class="checkbox-inline pull-left"><input type="checkbox"> Remember me</label>
                                          <input type="submit" class="btn btn-danger pull-right" value="Register">
                                      </div>
                                  </form>
                                </div>
                              </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-7 mx-auto text-center" data-aos="fade-up">
                        ...
                        <p>Whatever suits your eye,just bid it and give it a try!</p>
                        <p><a href="#myModal1" class="btn btn-danger trigger-btn text-white" data-toggle="modal">Register</a></p>
                         <div id="myModal1" class="modal fade">
                              <div class="modal-dialog modal-login">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">        
                                      ...
                                      <div class="modal-body">        
                                          <div class="form-group">
                                            ...
                                            <input type="phoneNumber" required="required">
                                          </div>
                                          <div class="form-group">
                                            <div class="clearfix">
                                              <label>Password</label>
